...
{
    public class StoreAccountPortalUri
    {
        // https://portal.azure.com/#resource/subscriptions/ace74b35-b0de-428b-a1d9-55459d7a6e30/resourceGroups/adlpminsights/providers/Microsoft.DataLakeStore/accounts/adlpm/overview

        public readonly string SubscriptionId;
        public readonly string ResourceGroup;
        public readonly string Account;

        public StoreAccountPortalUri(string subid, string rg, string account)
        {
        ...
        public StoreAccountPortalUri(AnalyticsAccountRef job_ref)
        {
        ...
        public override string ToString()
        {
            string uri =
                string.Format(
                    "https://portal.azure.com/#resource/subscriptions/{0}/resourcegroups/{1}/providers/Microsoft.DataLakeStore/accounts/{2}/jobId/{3}/overview",
                    this.SubscriptionId, this.ResourceGroup, this.Account);
            return uri;
        }

        public static StoreAccountPortalUri Parse(string s)
        {
            ...
            if (fragment_tokens[5] != "Microsoft.DataLakeStore")
            {
                throw new System.ArgumentException(
                    "Malformed job portal uri: missing \"Microsoft.DataLakeStore\" in Fragment at position 5");
            }
            ...
            // Final URI
            var account_portal_uri = new StoreAccountPortalUri(subid, rg, account_name);
