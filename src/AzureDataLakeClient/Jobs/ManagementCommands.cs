...
namespace AzureDataLakeClient.Jobs
{
    public class ManagementCommands
    {
        ...
        {
            this._restClientWrapper.UpdateAccount(this.account.ResourceGroup, account, parameters);
        }
        ...
        {
            this._restClientWrapper.AddStorageAccount(this.account.ResourceGroup, account, storage_account, parameters);
        }
        ...
        {
            this._restClientWrapper.AddDataLakeStoreAccount(this.account.ResourceGroup, account, storage_account, parameters);
        }
        ...
        {
            return this._restClientWrapper.ListStoreAccounts(this.account.ResourceGroup, account);
        }

        public IEnumerable<Microsoft.Azure.Management.DataLake.Analytics.Models.StorageAccountInfo> ListLinkedBlobStorageAccounts()
        {
            return this._restClientWrapper.ListStorageAccounts(account.ResourceGroup, account);
        }
        ...
        {
            return this._restClientWrapper.ListStorageContainers(account.ResourceGroup, account, storage_account);
        }

        public void UnlinkBlobStorageAccount(string storage_account)
        {
            this._restClientWrapper.DeleteStorageAccount(account.ResourceGroup, account, storage_account);
        }

        public void UnlinkDataLakeStoreAccount(string storage_account)
        {
            this._restClientWrapper.DeleteDataLakeStoreAccount(account.ResourceGroup, account, storage_account);
        }
        ...
        {
            return this._restClientWrapper.ListSasTokens(account.ResourceGroup, account, storage_account, container);
        }
