...
namespace AzureDataLakeClient.Rest
{
    public class AnalyticsAccountManagmentRestWrapper
    {
        ...
        public IEnumerable<MSADL.Analytics.Models.DataLakeAnalyticsAccount> ListAccounts(AzureDataLakeClient.Rm.ResourceGroup rg)
        {
        ...
        public MSADL.Analytics.Models.DataLakeAnalyticsAccount GetAccount(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account)
        {
        ...
        public void UpdateAccount(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account, MSADL.Analytics.Models.DataLakeAnalyticsAccountUpdateParameters parameters)
        {
            this._adla_acctmgmt_client.Account.Update(rg.Name, account.Name, parameters);
        }

        public void AddStorageAccount(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account, string storage_account, MSADL.Analytics.Models.AddStorageAccountParameters parameters)
        {
            this._adla_acctmgmt_client.StorageAccounts.Add(rg.Name, account.Name, storage_account, parameters);
        }

        public void AddDataLakeStoreAccount(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account, string storage_account, MSADL.Analytics.Models.AddDataLakeStoreParameters parameters)
        {
            this._adla_acctmgmt_client.DataLakeStoreAccounts.Add(rg.Name, account.Name, storage_account, parameters);
        }

        public IEnumerable<MSADL.Analytics.Models.DataLakeStoreAccountInfo> ListStoreAccounts(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account)
        {
        ...
        public IEnumerable<MSADL.Analytics.Models.StorageAccountInfo> ListStorageAccounts(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account)
        {
        ...
        public IEnumerable<MSADL.Analytics.Models.StorageContainer> ListStorageContainers(AzureDataLakeClient.Rm.ResourceGroup rg, AnalyticsAccount account, string storage_account)
        {
        ...
        public IEnumerable<MSADL.Analytics.Models.SasTokenInfo> ListSasTokens(AzureDataLakeClient.Rm.ResourceGroup resource_group, AnalyticsAccount account, string storage_account, string container)
        {
