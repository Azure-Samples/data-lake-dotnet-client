...
namespace ADL_Client_Tests.Store
{
    ...
    public class Store_Filesystem_Tests : Base_Tests
    {
        ...
        public void List_Files_Recursive()
        {
            ...
            var pages = this.adls_fs_client.ListFilesRecursivePaged(AzureDataLakeClient.Store.FsPath.Root, lfo);
        ...
        public void List_Files_Non_Recursive()
        {
            ...
            var pages = this.adls_fs_client.ListFilesPaged(AzureDataLakeClient.Store.FsPath.Root, lfo);
            foreach (var page in pages)
            {
